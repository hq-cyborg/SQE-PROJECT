...
const mockListAll = jest.fn((req, res) => {
  return res.status(200).json({
    success: true,
    allItems: ['payment1', 'payment2', 'payment3'],
  });
});
...
describe('PAYMENT LISTALL ROUTER API - MOCK TEST', () => {
  let app;
  ...
  it('should call paymentController.listAll and return 200', async () => {
    const res = await request(app).get('/payment/listAll');
